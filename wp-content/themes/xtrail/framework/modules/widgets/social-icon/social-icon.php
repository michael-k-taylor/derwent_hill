...
if ( class_exists( 'XtrailCoreClassWidget' ) ) {
	class XtrailSelectClassSocialIconWidget extends XtrailCoreClassWidget {
		
		public function __construct() {
			parent::__construct(
				'qodef_social_icon_widget',
				esc_html__( 'Xtrail Social Icon Widget', 'xtrail' ),
				array( 'description' => esc_html__( 'Add social network icons to widget areas', 'xtrail' ) )
			);
			...
			$this->params = array_merge(
				array(
					array(
						'type'        => 'dropdown',
						'name'        => 'icon_text',
						'title'       => esc_html__( 'Display Icon or Text', 'xtrail' ),
						'description' => esc_html__( 'Choose whether you want to display social icon or text instead', 'xtrail' ),
						'options'     => array(
							'icon' => esc_html__( 'Icon', 'xtrail' ),
							'text' => esc_html__( 'Text', 'xtrail' )
						)
					),
					array(
						'type'        => 'textfield',
						'name'        => 'social_text',
						'title'       => esc_html__( 'Social Text', 'xtrail' ),
						'description' => esc_html__( 'Instert text which will describe desired social network', 'xtrail' )
					)
				),
				xtrail_select_icon_collections()->getSocialIconWidgetParamsArray(),
				array(
					array(
						'type'  => 'textfield',
						'name'  => 'link',
