...
if ( class_exists( 'XtrailCoreClassWidget' ) ) {
	class XtrailSelectClassBlogListWidget extends XtrailCoreClassWidget {
		public function __construct() {
			parent::__construct(
				'qodef_blog_list_widget',
				esc_html__( 'Xtrail Blog List Widget', 'xtrail' ),
				array( 'description' => esc_html__( 'Display a list of your blog posts', 'xtrail' ) )
			);
			...
			$this->params = array(
				...
				array(
					...
					'options' => array(
						...
						'minimal' => esc_html__( 'Minimal', 'xtrail' )
					)
				),
				array(
					'type'  => 'textfield',
					'name'  => 'number_of_posts',
					'title' => esc_html__( 'Number of Posts', 'xtrail' )
				),
				array(
					'type'    => 'dropdown',
				...
				array(
					'type'    => 'dropdown',
					'name'    => 'orderby',
					'title'   => esc_html__( 'Order By', 'xtrail' ),
					'options' => xtrail_select_get_query_order_by_array()
				),
				array(
					'type'    => 'dropdown',
					'name'    => 'order',
					'title'   => esc_html__( 'Order', 'xtrail' ),
					'options' => xtrail_select_get_query_order_array()
				),
				array(
					'type'        => 'textfield',
					'name'        => 'category',
					'title'       => esc_html__( 'Category Slug', 'xtrail' ),
					'description' => esc_html__( 'Leave empty for all or use comma for list', 'xtrail' )
				),
				array(
					'type'    => 'dropdown',
					'name'    => 'title_tag',
				...
				array(
					...
					'title'   => esc_html__( 'Title Text Transform', 'xtrail' ),
		...
		public function widget( $args, $instance ) {
			...
			echo '<div class="widget qodef-blog-list-widget" ' . xtrail_select_get_inline_style( $widget_styles ) . '>';
