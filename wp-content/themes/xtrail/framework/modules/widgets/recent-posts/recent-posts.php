...
if ( class_exists( 'XtrailCoreClassWidget' ) ) {
	class XtrailSelectClassRecentPosts extends XtrailCoreClassWidget {
		public function __construct() {
			parent::__construct(
				'qodef_recent_posts',
				esc_html__( 'Xtrail Recent Posts', 'xtrail' ),
				array( 'description' => esc_html__( 'Select recent posts that you would like to display', 'xtrail' ) )
			);
		...
		public function widget( $args, $instance ) {
			...
			$html = '<div class="widget qodef-recent-post-widget" ' . xtrail_select_get_inline_style( $widget_styles ) . '>';
			...
			if ( $query->have_posts() ) {
				...
				$html .= esc_html__( 'Sorry, there are no posts matching your criteria', 'xtrail' );
			}
			...
			echo xtrail_select_get_module_part( $html );
		}
	}
}