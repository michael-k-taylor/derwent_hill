<?php
$blog_single_navigation = xtrail_select_options()->getOptionValue('blog_single_navigation') === 'no' ? false : true;
$blog_navigation_through_same_category = xtrail_select_options()->getOptionValue('blog_navigation_through_same_category') === 'no' ? false : true;
?>
		...
		<div class="qodef-blog-single-navigation-inner clearfix">
			<?php
				...
				$post_navigation = array(
					'prev' => array(
						'mark' => '<span class="qodef-blog-single-nav-mark"></span>',
						'label' => '<span class="qodef-blog-single-nav-label">'.esc_html__('previous post', 'xtrail').'</span>'
					),
					'next' => array(
						'mark' => '<span class="qodef-blog-single-nav-mark"></span>',
						'label' => '<span class="qodef-blog-single-nav-label">'.esc_html__('next post', 'xtrail').'</span>'
					)
				);
