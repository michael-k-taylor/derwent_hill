...
if ( ! function_exists( 'xtrail_select_get_hide_dep_for_header_vertical_area_meta_boxes' ) ) {
	function xtrail_select_get_hide_dep_for_header_vertical_area_meta_boxes() {
		$hide_dep_options = apply_filters( 'xtrail_select_filter_header_vertical_hide_meta_boxes', $hide_dep_options = array( '' => '' ) );
		
		return $hide_dep_options;
	}
}

if ( ! function_exists( 'xtrail_select_header_vertical_area_meta_options_map' ) ) {
	function xtrail_select_header_vertical_area_meta_options_map( $header_meta_box ) {
		$hide_dep_options = xtrail_select_get_hide_dep_for_header_vertical_area_meta_boxes();
		
		$header_vertical_area_meta_container = xtrail_select_add_admin_container(
			array(
		...
		xtrail_select_create_meta_box_field(
			array(
				...
				'type'          => 'yesno',
				'default_value' => 'no',
				'label'         => esc_html__( 'Disable Background Image', 'xtrail' ),
				'description'   => esc_html__( 'Enabling this option will hide background image in Vertical Menu', 'xtrail' ),
				'parent'        => $header_vertical_area_meta_container
			)
		);
		...
		xtrail_select_create_meta_box_field(
			array(
				...
				'description'   => esc_html__( 'Set shadow on vertical menu', 'xtrail' ),
				'parent'        => $header_vertical_area_meta_container,
				'default_value' => '',
		...
		$vertical_header_border_container = xtrail_select_add_admin_container(
			array(
				'type'            => 'container',
		...
		xtrail_select_create_meta_box_field(
			array(
				...
				'description' => esc_html__( 'Choose color of border', 'xtrail' ),
	...
	add_action( 'xtrail_select_action_additional_header_area_meta_boxes_map', 'xtrail_select_header_vertical_area_meta_options_map' );
}