...
if ( ! function_exists( 'xtrail_select_get_hide_dep_for_header_vertical_menu_options' ) ) {
	function xtrail_select_get_hide_dep_for_header_vertical_menu_options() {
		$hide_dep_options = apply_filters( 'xtrail_select_filter_header_vertical_menu_hide_global_option', $hide_dep_options = array() );
		
		return $hide_dep_options;
	}
}

if ( ! function_exists( 'xtrail_select_header_vertical_navigation_options_map' ) ) {
	function xtrail_select_header_vertical_navigation_options_map() {
		$hide_dep_options = xtrail_select_get_hide_dep_for_header_vertical_menu_options();
		
		$panel_vertical_main_menu = xtrail_select_add_admin_panel(
			array(
				'title'           => esc_html__( 'Vertical Main Menu', 'xtrail' ),
		...
		$drop_down_group = xtrail_select_add_admin_group(
			array(
				...
				'description' => esc_html__( 'Set a style for dropdown menu', 'xtrail' )
			)
		);
		
		$vertical_drop_down_row1 = xtrail_select_add_admin_row(
			array(
		...
		xtrail_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Top Margin', 'xtrail' ),
				'args'          => array(
					'suffix' => 'px'
				),
		...
		xtrail_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Bottom Margin', 'xtrail' ),
				'args'          => array(
					'suffix' => 'px'
				),
				'parent'        => $vertical_drop_down_row1
		...
		xtrail_select_add_admin_field(
			array(
				...
				'default_value' => 'below',
				'label'         => esc_html__( 'Submenu Opening', 'xtrail' ),
				'options'		=> array(
					'below' => esc_html__('Below', 'xtrail'),
					'side' => esc_html__('On Side', 'xtrail'),
				),
				'parent'        => $panel_vertical_main_menu
			)
		);

		$group_vertical_first_level = xtrail_select_add_admin_group(
			array(
				'name'        => 'group_vertical_first_level',
				'title'       => esc_html__( '1st level', 'xtrail' ),
				'description' => esc_html__( 'Define styles for 1st level menu', 'xtrail' ),
				'parent'      => $panel_vertical_main_menu
			)
		);
		
		$row_vertical_first_level_1 = xtrail_select_add_admin_row(
			array(
		...
		$row_vertical_first_level_2 = xtrail_select_add_admin_row(
			array(
		...
		$row_vertical_first_level_3 = xtrail_select_add_admin_row(
			array(
		...
		$group_vertical_second_level = xtrail_select_add_admin_group(
			array(
				'name'        => 'group_vertical_second_level',
				'title'       => esc_html__( '2nd level', 'xtrail' ),
				'description' => esc_html__( 'Define styles for 2nd level menu', 'xtrail' ),
				'parent'      => $panel_vertical_main_menu
			)
		);
		
		$row_vertical_second_level_1 = xtrail_select_add_admin_row(
			array(
		...
		$row_vertical_second_level_2 = xtrail_select_add_admin_row(
			array(
		...
		$row_vertical_second_level_3 = xtrail_select_add_admin_row(
			array(
		...
		$group_vertical_third_level = xtrail_select_add_admin_group(
			array(
				'name'        => 'group_vertical_third_level',
				'title'       => esc_html__( '3rd level', 'xtrail' ),
				'description' => esc_html__( 'Define styles for 3rd level menu', 'xtrail' ),
				'parent'      => $panel_vertical_main_menu
			)
		);
		
		$row_vertical_third_level_1 = xtrail_select_add_admin_row(
			array(
		...
		$row_vertical_third_level_2 = xtrail_select_add_admin_row(
			array(
		...
		$row_vertical_third_level_3 = xtrail_select_add_admin_row(
			array(
	...
	add_action( 'xtrail_select_action_additional_header_main_navigation_options_map', 'xtrail_select_header_vertical_navigation_options_map', 10, 1 );
}