...
if ( ! function_exists( 'xtrail_select_get_hide_dep_for_header_main_menu_options' ) ) {
	function xtrail_select_get_hide_dep_for_header_main_menu_options() {
		$hide_dep_options = apply_filters( 'xtrail_select_filter_header_main_menu_hide_global_option', $hide_dep_options = array() );
		
		return $hide_dep_options;
	}
}

if ( ! function_exists( 'xtrail_select_header_main_navigation_options_map' ) ) {
	function xtrail_select_header_main_navigation_options_map() {
		$hide_dep_options = xtrail_select_get_hide_dep_for_header_main_menu_options();
		
		$panel_main_menu = xtrail_select_add_admin_panel(
			array(
				'title'           => esc_html__( 'Main Menu', 'xtrail' ),
		...
		xtrail_select_add_admin_section_title(
			array(
				...
				'title'  => esc_html__( 'Main Menu General Settings', 'xtrail' )
			)
		);
		
		$drop_down_group = xtrail_select_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'drop_down_group',
				'title'       => esc_html__( 'Main Dropdown Menu', 'xtrail' ),
				'description' => esc_html__( 'Choose a color and transparency for the main menu background (0 = fully transparent, 1 = opaque)', 'xtrail' )
			)
		);
		
		$drop_down_row1 = xtrail_select_add_admin_row(
			array(
		...
		xtrail_select_add_admin_field(
			array(
				...
				'label'         => esc_html__( 'Main Dropdown Menu Appearance', 'xtrail' ),
				'description'   => esc_html__( 'Choose appearance for dropdown menu', 'xtrail' ),
				'options'       => array(
					'dropdown-default'        => esc_html__( 'Default', 'xtrail' ),
					'dropdown-animate-height' => esc_html__( 'Animate Height', 'xtrail' )
				)
			)
		);
		...
		$first_level_group = xtrail_select_add_admin_group(
			array(
				...
				'title'       => esc_html__( '1st Level Menu', 'xtrail' ),
				'description' => esc_html__( 'Define styles for 1st level in Top Navigation Menu', 'xtrail' )
			)
		);
		...
		xtrail_select_add_admin_field(
			array(
				'parent'        => $first_level_row2,
				'type'          => 'colorsimple',
				'name'          => 'menu_hovercolor_background',
				'default_value' => '',
				'label'         => esc_html__( 'Hover Background Text Color', 'xtrail' ),
			)
		);
		...
		xtrail_select_add_admin_field(
			array(
				'parent'        => $first_level_row2,
				'type'          => 'colorsimple',
				'name'          => 'menu_activecolor_background',
				'default_value' => '',
				'label'         => esc_html__( 'Active Background Text Color', 'xtrail' ),
			)
		);
		...
		xtrail_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Light Menu Hover Text Color', 'xtrail' ),
			)
		);
		...
		xtrail_select_add_admin_field(
			array(
				'parent'        => $first_level_row3,
				'type'          => 'colorsimple',
				'name'          => 'menu_light_hovercolor_background',
				'default_value' => '',
				'label'         => esc_html__( 'Hover Light Background Text Color', 'xtrail' ),
			)
		);
		...
		xtrail_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Light Menu Active Text Color', 'xtrail' ),
			)
		);
		...
		xtrail_select_add_admin_field(
			array(
				'parent'        => $first_level_row3,
				'type'          => 'colorsimple',
				'name'          => 'menu_light_activecolor_background',
				'default_value' => '',
				'label'         => esc_html__( 'Active Light Background Text Color', 'xtrail' ),
			)
		);
		
		$first_level_row4 = xtrail_select_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		xtrail_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Dark Menu Hover Text Color', 'xtrail' ),
			)
		);
		...
		xtrail_select_add_admin_field(
			array(
				'parent'        => $first_level_row4,
				'type'          => 'colorsimple',
				'name'          => 'menu_dark_hovercolor_background',
				'default_value' => '',
				'label'         => esc_html__( 'Hover Dark Background Text Color', 'xtrail' ),
			)
		);
		...
		xtrail_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Dark Menu Active Text Color', 'xtrail' ),
			)
		);
		...
		xtrail_select_add_admin_field(
			array(
				'parent'        => $first_level_row4,
				'type'          => 'colorsimple',
				'name'          => 'menu_dark_activecolor_background',
				'default_value' => '',
				'label'         => esc_html__( 'Active Dark Background Text Color', 'xtrail' ),
			)
		);
		
		$first_level_row5 = xtrail_select_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		$first_level_row6 = xtrail_select_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		$first_level_row7 = xtrail_select_add_admin_row(
			array(
				'parent' => $first_level_group,
		...
		xtrail_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Left/Right', 'xtrail' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		xtrail_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Left/Right', 'xtrail' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$second_level_group = xtrail_select_add_admin_group(
			array(
				...
				'title'       => esc_html__( '2nd Level Menu', 'xtrail' ),
				'description' => esc_html__( 'Define styles for 2nd level in Top Navigation Menu', 'xtrail' )
			)
		);
		...
		xtrail_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Hover/Active Color', 'xtrail' )
			)
		);
		...
		$second_level_wide_group = xtrail_select_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'second_level_wide_group',
				'title'       => esc_html__( '2nd Level Wide Menu', 'xtrail' ),
				'description' => esc_html__( 'Define styles for 2nd level in Wide Menu', 'xtrail' )
			)
		);
		
		$second_level_wide_row1 = xtrail_select_add_admin_row(
			array(
		...
		$second_level_wide_row2 = xtrail_select_add_admin_row(
			array(
				'parent' => $second_level_wide_group,
		...
		$second_level_wide_row3 = xtrail_select_add_admin_row(
			array(
				'parent' => $second_level_wide_group,
		...
		$third_level_group = xtrail_select_add_admin_group(
			array(
				...
				'title'       => esc_html__( '3nd Level Menu', 'xtrail' ),
				'description' => esc_html__( 'Define styles for 3nd level in Top Navigation Menu', 'xtrail' )
			)
		);
		...
		$third_level_wide_group = xtrail_select_add_admin_group(
			array(
				'parent'      => $panel_main_menu,
				'name'        => 'third_level_wide_group',
				'title'       => esc_html__( '3rd Level Wide Menu', 'xtrail' ),
				'description' => esc_html__( 'Define styles for 3rd level in Wide Menu', 'xtrail' )
			)
		);
		
		$third_level_wide_row1 = xtrail_select_add_admin_row(
			array(
		...
		$third_level_wide_row2 = xtrail_select_add_admin_row(
			array(
				'parent' => $third_level_wide_group,
		...
		$third_level_wide_row3 = xtrail_select_add_admin_row(
			array(
				'parent' => $third_level_wide_group,
	...
	add_action( 'xtrail_select_action_header_main_navigation_options_map', 'xtrail_select_header_main_navigation_options_map', 10, 1 );
}