...
if ( ! function_exists( 'xtrail_select_content_bottom_options_map' ) ) {
	function xtrail_select_content_bottom_options_map() {
		
		$panel_content_bottom = xtrail_select_add_admin_panel(
			array(
				'page'  => '_page_page',
				'name'  => 'panel_content_bottom',
				'title' => esc_html__( 'Content Bottom Area Style', 'xtrail' )
			)
		);
		...
		$enable_content_bottom_area_container = xtrail_select_add_admin_container(
			array(
				'parent'          => $panel_content_bottom,
		...
		xtrail_select_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Widget Area to Display', 'xtrail' ),
				'description'   => esc_html__( 'Choose a Content Bottom widget area to display', 'xtrail' ),
	...
	add_action( 'xtrail_select_action_additional_page_options_map', 'xtrail_select_content_bottom_options_map' );
}