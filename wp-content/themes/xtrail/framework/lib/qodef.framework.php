...
/*
   Class: XtrailSelectClassFramework
...
class XtrailSelectClassFramework {
	...
	private function __construct() {
		$this->qodeOptions         = XtrailSelectClassOptions::get_instance();
		$this->qodeMetaBoxes       = XtrailSelectClassMetaBoxes::get_instance();
		$this->qodeTaxonomyOptions = XtrailSelectClassTaxonomyOptions::get_instance();
		$this->qodeUserOptions     = XtrailSelectClassUserOptions::get_instance();
		$this->qodeDashboardOptions = XtrailSelectClassDashboardOptions::get_instance();
	}
	...
	public function setSkin( XtrailSelectClassSkinAbstract $skinObject ) {
		$this->skin = $skinObject;
	}
}

/**
 * Class XtrailSelectClassSkinManager
 *
...
class XtrailSelectClassSkinManager {
	...
	/**
	 * @see XtrailSelectClassSkinManager::setSkin()
	 */
	...
	private function setSkin( $skinName = SELECT_PROFILE_SLUG ) {
		if ( $skinName !== '' ) {
			if ( file_exists( get_template_directory() . '/framework/admin/skins/' . $skinName . '/skin.php' ) ) {
				...
				$skinName = ucfirst( $skinName ) . esc_html__( 'Skin', 'xtrail' );
...
/**
 * Class XtrailSelectClassSkinAbstract
 *
 * Abstract class that each skin class must extend
 */
abstract class XtrailSelectClassSkinAbstract {
	/**
	 * @var string
	 */
	protected $skinName;
	...
	public function loadTemplatePart( $template, $params = array() ) {
		...
		if ( $template !== '' ) {
			include( xtrail_select_find_template_path( 'framework/admin/skins/' . $this->skinName . '/templates/' . $template . '.php' ) );
		}
	}
	...
	public function setShortcodeJSParams() { ?>
		<script>
			window.qodeSCIcon = '<?php echo xtrail_select_get_skin_uri() . '/assets/img/admin-logo-icon.png'; ?>';
			window.qodeSCLabel = '<?php echo esc_html( ucfirst( $this->skinName ) ); ?> <?php esc_html_e( 'Shortcodes', 'xtrail' ) ?>';
		</script>
	<?php }
...
/*
   Class: XtrailSelectClassOptions
...
class XtrailSelectClassOptions {
	...
	public function getOptionValue( $key ) {
		...
		if ( array_key_exists( $key, $xtrail_select_global_options ) ) {
			return $xtrail_select_global_options[ $key ];
...
/*
   Class: XtrailSelectClassAdminPage
   A class that initializes Select Admin Page
*/
class XtrailSelectClassAdminPage implements iXtrailSelectInterfaceLayoutNode {
	public $layout;
	private $factory;
	public $slug;
	public $title;
	...
	function __construct( $slug = "", $title = "", $icon = "" ) {
		$this->layout  = array();
		$this->factory = new XtrailSelectClassFieldFactory();
		$this->slug    = $slug;
		$this->title   = $title;
		$this->icon    = $icon;
	}
	...
	public function renderChild( iXtrailSelectInterfaceRender $child ) {
		$child->render( $this->factory );
	}
}

/*
   Class: XtrailSelectClassMetaBoxes
...
/*
   Class: XtrailSelectClassMetaBox
   A class that initializes Select Meta Box
*/
class XtrailSelectClassMetaBox implements iXtrailSelectInterfaceLayoutNode {
	public $layout;
	private $factory;
	public $scope;
	public $title;
	...
	public function setTitle( $label ) {
		...
		return $xtrail_select_global_Framework->getSkin()->getSkinLabel() . ' ' . $label;
	}
}

/*
   Class: XtrailSelectClassTaxonomyOptions
   A class that initializes XtrailSelectClass Taxonomy Options
*/
class XtrailSelectClassTaxonomyOptions {
	private static $instance;
...
/*
   Class: XtrailSelectClassTaxonomyOption
   A class that initializes XtrailSelectClass Taxonomy Option
*/
class XtrailSelectClassTaxonomyOption implements iXtrailSelectInterfaceLayoutNode {
	public $layout;
	private $factory;
	public $scope;
	...
	function __construct( $scope = "" ) {
		$this->layout  = array();
		$this->factory = new XtrailSelectClassTaxonomyFieldFactory();
		$this->scope   = $scope;
	}
...
/*
   Class: XtrailSelectClassUserOptions
   A class that initializes XtrailSelectClass User Options
*/
class XtrailSelectClassUserOptions {
	private static $instance;
	public $userOptions;
...
/*
   Class: XtrailSelectClassUserOption
   A class that initializes XtrailSelectClass User Option
*/
class XtrailSelectClassUserOption implements iXtrailSelectInterfaceLayoutNode {
	public $layout;
	private $factory;
	public $scope;
	...
	function __construct( $scope = "" ) {
		$this->layout  = array();
		$this->factory = new XtrailSelectClassUserFieldFactory();
		$this->scope   = $scope;
	}
...
/*
   Class: XtrailSelectClassDashboardOptions
   A class that initializes XtrailSelectClass Dashboard Options
*/
class XtrailSelectClassDashboardOptions {
	private static $instance;
...
/*
   Class: XtrailSelectClassDashboardOption
   A class that initializes XtrailSelectClass Dashboard Option
*/
class XtrailSelectClassDashboardOption implements iXtrailSelectInterfaceLayoutNode {
	public $layout;
	private $factory;
	
	function __construct() {
		$this->layout        = array();
		$this->factory       = new XtrailSelectClassDashboardFieldFactory();
	}
...
if ( ! function_exists( 'xtrail_select_init_framework_variable' ) ) {
	function xtrail_select_init_framework_variable() {
		global $xtrail_select_global_Framework;
		
		$xtrail_select_global_Framework = XtrailSelectClassFramework::get_instance();
		$qodeSkinManager                 = new XtrailSelectClassSkinManager();
		$xtrail_select_global_Framework->setSkin( $qodeSkinManager->getSkin() );
	}
	
	add_action( 'xtrail_select_action_before_options_map', 'xtrail_select_init_framework_variable' );
}
?>