...
if ( ! function_exists( 'xtrail_select_add_simple_line_icon_pack' ) ) {
	function xtrail_select_add_simple_line_icon_pack( $iconCollections ) {
		$iconCollections['simple_line_icons'] = new XtrailSelectClassSimpleLineIcons( 'Simple Line Icons', 'simple_line_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'xtrail_select_filter_add_icon_pack_into_collection', 'xtrail_select_add_simple_line_icon_pack' );
}

if ( ! function_exists( 'xtrail_select_add_simple_line_icon_pack_option' ) ) {
	function xtrail_select_add_simple_line_icon_pack_option( $options ) {
		$options['simple_line_icons'] = esc_html__( 'Simple Line Icons', 'xtrail' );
		
		return $options;
	}
	
	add_filter( 'xtrail_select_filter_add_icon_pack_into_options', 'xtrail_select_add_simple_line_icon_pack_option' );
	add_filter( 'xtrail_select_filter_add_icon_pack_into_social_options', 'xtrail_select_add_simple_line_icon_pack_option' );
}

class XtrailSelectClassSimpleLineIcons implements iXtrailSelectInterfaceIconCollection {
    public $icons;
    public $title;
    public $param;
    public $styleUrl;
    ...
    public function __construct($title = "", $param = "") {
        ...
        $this->styleUrl = SELECT_FRAMEWORK_ICONS_ROOT . '/simple-line-icons/simple-line-icons.css';
    }
    ...
    public function setSocialIconsArray() {
        $this->socialIcons = array(
            ''                        => '',
            'icon-social-behance'     => esc_html__('Behance', 'xtrail'),
            'icon-social-dribbble'    => esc_html__('Dribbble', 'xtrail'),
            'icon-social-dropbox'     => esc_html__('Dropbox', 'xtrail'),
            'icon-social-facebook'    => esc_html__('Facebook', 'xtrail'),
            'icon-social-foursquare'  => esc_html__('Foursquare', 'xtrail'),
            'icon-social-github'      => esc_html__('Github', 'xtrail'),
            'icon-social-gplus'       => esc_html__('Google Plus', 'xtrail'),
            'icon-social-instagram'   => esc_html__('Instagram', 'xtrail'),
            'icon-social-linkedin'    => esc_html__('LinkedIn', 'xtrail'),
            'icon-social-pintarest'   => esc_html__('Pinterest', 'xtrail'),
            'icon-social-reddit'      => esc_html__('Reddit', 'xtrail'),
            'icon-social-skype'       => esc_html__('Skype', 'xtrail'),
            'icon-social-soundcloud'  => esc_html__('Soundcloud', 'xtrail'),
            'icon-social-stumbleupon' => esc_html__('Stumbleupon', 'xtrail'),
            'icon-social-spotify'     => esc_html__('Spotify', 'xtrail'),
            'icon-social-tumblr'      => esc_html__('Tumblr', 'xtrail'),
            'icon-social-twitter'     => esc_html__('Twitter', 'xtrail'),
            'icon-social-youtube'     => esc_html__('Youtube', 'xtrail')
        );
    }
