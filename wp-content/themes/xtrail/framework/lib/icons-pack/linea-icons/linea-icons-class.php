...
if ( ! function_exists( 'xtrail_select_add_linea_icon_pack' ) ) {
	function xtrail_select_add_linea_icon_pack( $iconCollections ) {
		$iconCollections['linea_icons'] = new XtrailSelectClassLineaIcons( 'Linea Icons', 'linea_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'xtrail_select_filter_add_icon_pack_into_collection', 'xtrail_select_add_linea_icon_pack' );
}

if ( ! function_exists( 'xtrail_select_add_linea_icon_pack_option' ) ) {
	function xtrail_select_add_linea_icon_pack_option( $options ) {
		$options['linea_icons'] = esc_html__( 'Linea Icons', 'xtrail' );
		
		return $options;
	}
	
	add_filter( 'xtrail_select_filter_add_icon_pack_into_options', 'xtrail_select_add_linea_icon_pack_option' );
}

class XtrailSelectClassLineaIcons implements iXtrailSelectInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
	...
	public function __construct($title = "", $param = "") {
		...
		$this->param = $param;
		$this->setIconsArray();
		$this->styleUrl = SELECT_FRAMEWORK_ICONS_ROOT . '/linea-icons/style.css';
	}
