...
if ( ! function_exists( 'xtrail_select_add_font_awesome_icon_pack' ) ) {
	function xtrail_select_add_font_awesome_icon_pack( $iconCollections ) {
		$iconCollections['font_awesome'] = new XtrailSelectClassIconsFontAwesome( 'Font Awesome', 'fa_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'xtrail_select_filter_add_icon_pack_into_collection', 'xtrail_select_add_font_awesome_icon_pack' );
}

if ( ! function_exists( 'xtrail_select_add_font_awesome_icon_pack_option' ) ) {
	function xtrail_select_add_font_awesome_icon_pack_option( $options ) {
		$options['font_awesome'] = esc_html__( 'Font Awesome', 'xtrail' );
		
		return $options;
	}
	
	add_filter( 'xtrail_select_filter_add_icon_pack_into_options', 'xtrail_select_add_font_awesome_icon_pack_option' );
	add_filter( 'xtrail_select_filter_add_icon_pack_into_social_options', 'xtrail_select_add_font_awesome_icon_pack_option' );
}

class XtrailSelectClassIconsFontAwesome implements iXtrailSelectInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
