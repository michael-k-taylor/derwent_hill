...
if ( ! function_exists( 'xtrail_select_add_ion_icon_pack' ) ) {
	function xtrail_select_add_ion_icon_pack( $iconCollections ) {
		$iconCollections['ion_icons'] = new XtrailSelectClassIonIcons( 'Ion Icons', 'ion_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'xtrail_select_filter_add_icon_pack_into_collection', 'xtrail_select_add_ion_icon_pack' );
}

if ( ! function_exists( 'xtrail_select_add_ion_icon_pack_option' ) ) {
	function xtrail_select_add_ion_icon_pack_option( $options ) {
		$options['ion_icons'] = esc_html__( 'Ion Icons', 'xtrail' );
		
		return $options;
	}
	
	add_filter( 'xtrail_select_filter_add_icon_pack_into_options', 'xtrail_select_add_ion_icon_pack_option' );
	add_filter( 'xtrail_select_filter_add_icon_pack_into_social_options', 'xtrail_select_add_ion_icon_pack_option' );
}

class XtrailSelectClassIonIcons implements iXtrailSelectInterfaceIconCollection {
	public $icons;
	public $socialIcons;
    public $title;
	public $param;
	...
	public function getSearchClose() {
		return $this->render('ion-ios-close-empty');
	}

	public function getDropdownCartIcon() {
		return $this->render('ion-ios-cart');
	}
