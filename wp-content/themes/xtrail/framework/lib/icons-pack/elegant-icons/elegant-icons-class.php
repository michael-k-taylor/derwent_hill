...
if ( ! function_exists( 'xtrail_select_add_font_elegant_icon_pack' ) ) {
	function xtrail_select_add_font_elegant_icon_pack( $iconCollections ) {
		$iconCollections['font_elegant'] = new XtrailSelectClassIconsFontElegant( 'Font Elegant', 'fe_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'xtrail_select_filter_add_icon_pack_into_collection', 'xtrail_select_add_font_elegant_icon_pack' );
}

if ( ! function_exists( 'xtrail_select_add_font_elegant_icon_pack_option' ) ) {
	function xtrail_select_add_font_elegant_icon_pack_option( $options ) {
		$options['font_elegant'] = esc_html__( 'Font Elegant', 'xtrail' );
		
		return $options;
	}
	
	add_filter( 'xtrail_select_filter_add_icon_pack_into_options', 'xtrail_select_add_font_elegant_icon_pack_option' );
	add_filter( 'xtrail_select_filter_add_icon_pack_into_social_options', 'xtrail_select_add_font_elegant_icon_pack_option' );
}

class XtrailSelectClassIconsFontElegant implements iXtrailSelectInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
	...
	function __construct($title = "", $param = "") {
		...
		$this->styleUrl = SELECT_FRAMEWORK_ICONS_ROOT . '/elegant-icons/style.min.css';
	}
