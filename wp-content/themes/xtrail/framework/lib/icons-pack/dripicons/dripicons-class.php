...
if ( ! function_exists( 'xtrail_select_add_dripicons_icon_pack' ) ) {
	function xtrail_select_add_dripicons_icon_pack( $iconCollections ) {
		$iconCollections['dripicons'] = new XtrailSelectClassDripicons( 'Dripicons', 'dripicon' );
		
		return $iconCollections;
	}
	
	add_filter( 'xtrail_select_filter_add_icon_pack_into_collection', 'xtrail_select_add_dripicons_icon_pack' );
}

if ( ! function_exists( 'xtrail_select_add_dripicons_icon_pack_option' ) ) {
	function xtrail_select_add_dripicons_icon_pack_option( $options ) {
		$options['dripicons'] = esc_html__( 'Dripicons', 'xtrail' );
		
		return $options;
	}
	
	add_filter( 'xtrail_select_filter_add_icon_pack_into_options', 'xtrail_select_add_dripicons_icon_pack_option' );
}

class XtrailSelectClassDripicons implements iXtrailSelectInterfaceIconCollection {
    public $icons;
    public $title;
    public $param;
    public $styleUrl;
    ...
    public function __construct($title = "", $param = "") {
        ...
        $this->param = $param;
        $this->setIconsArray();
        $this->styleUrl = SELECT_FRAMEWORK_ICONS_ROOT . '/dripicons/dripicons.css';
    }
