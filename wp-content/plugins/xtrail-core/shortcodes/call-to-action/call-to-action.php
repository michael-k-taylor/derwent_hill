<?php
namespace XtrailCore\CPT\Shortcodes\CallToAction;
...
class CallToAction implements Lib\ShortcodeInterface
{
    ...
    public function vcMap() {
        if (function_exists('vc_map')) {
            vc_map(
                array(
                    'name'                      => esc_html__('Call To Action', 'xtrail-core'),
                    'base'                      => $this->getBase(),
                    ...
                    'params'                    => array(
                        ...
                        array(
                            'type'        => 'dropdown',
                            'param_name'  => 'layout',
                            'heading'     => esc_html__('Layout', 'xtrail-core'),
                            'value'       => array(
                                esc_html__('Normal', 'xtrail-core') => 'normal',
                                esc_html__('Simple', 'xtrail-core') => 'simple'
                            ),
                            'save_always' => true
                        ),
                        array(
                            ...
                            'heading'    => esc_html__('Set Content In Grid', 'xtrail-core'),
                        ...
                        array(
                            ...
                            'heading'    => esc_html__('Content Elements Proportion', 'xtrail-core'),
                            'value'      => array(
                                esc_html__('80/20', 'xtrail-core') => '80',
                                esc_html__('75/25', 'xtrail-core') => '75',
                                esc_html__('66/33', 'xtrail-core') => '66',
                                esc_html__('50/50', 'xtrail-core') => '50'
                            ),
                            'dependency' => array('element' => 'layout', 'value' => array('normal'))
                        ),
                        array(
                            'type'       => 'dropdown',
                            'param_name' => 'enable_box_holder',
                            'heading'    => esc_html__('Box Holder', 'xtrail-core'),
                            'value'      => array_flip(xtrail_select_get_yes_no_select_array())
                        ),
                        array(
                            'type'        => 'textfield',
                            'param_name'  => 'box_holder_shadow',
                            'heading'     => esc_html__('Box Holder Shadow', 'xtrail-core'),
                            'dependency'  => array('element' => 'enable_box_holder', 'value' => array('yes')),
                            'description' => esc_html__('Insert in format: h-offset v-offset blur spread color (e.g. 7px 12px 35px 0px rgba(0, 0, 0, 0.03))', 'xtrail-core')
                        ),
                        array(
                            'type'       => 'colorpicker',
                            'param_name' => 'box_holder_background',
                            'heading'    => esc_html__('Box Holder Background', 'xtrail-core'),
                            'dependency' => array('element' => 'enable_box_holder', 'value' => array('yes')),
                        ),
                        array(
                            'type'       => 'dropdown',
                            'param_name' => 'close_button',
                            'heading'    => esc_html__('Hide/Close Button', 'xtrail-core'),
                            'value'      => array_flip(xtrail_select_get_yes_no_select_array())
                        ),
                        array(
                            'type'        => 'textfield',
                            ...
                            'value'       => esc_html__('Button Text', 'xtrail-core'),
                            'save_always' => true
                        ),
                        array(
                            'type'       => 'textfield',
                            'param_name' => 'button_top_margin',
                            'heading'    => esc_html__('Button Top Margin (px)', 'xtrail-core'),
                            'dependency' => array('element' => 'layout', 'value' => array('simple')),
                            'group'      => esc_html__('Button Style', 'xtrail-core')
                        ),
                        array(
                            'type'        => 'dropdown',
                        ...
                        array(
                            ...
                            'heading'     => esc_html__('Button Size', 'xtrail-core'),
                            'value'       => array(
                        ...
                        array(
                            ...
                            'heading'    => esc_html__('Button Link Target', 'xtrail-core'),
                        ...
                        array(
                            ...
                            'heading'    => esc_html__('Button Color', 'xtrail-core'),
                            'group'      => esc_html__('Button Style', 'xtrail-core')
                        ),
                        array(
                            'type'       => 'colorpicker',
                            'param_name' => 'button_hover_color',
                            'heading'    => esc_html__('Button Hover Color', 'xtrail-core'),
                            'group'      => esc_html__('Button Style', 'xtrail-core')
                        ),
                        array(
                            'type'       => 'colorpicker',
                            'param_name' => 'button_background_color',
                            'heading'    => esc_html__('Button Background Color', 'xtrail-core'),
                        ...
                        array(
                            ...
                            'heading'    => esc_html__('Button Hover Background Color', 'xtrail-core'),
                            'group'      => esc_html__('Button Style', 'xtrail-core')
                        ),
                        array(
                            'type'       => 'colorpicker',
                            'param_name' => 'button_border_color',
                            'heading'    => esc_html__('Button Border Color', 'xtrail-core'),
                            'group'      => esc_html__('Button Style', 'xtrail-core')
                        ),
                        array(
                            'type'       => 'colorpicker',
                            'param_name' => 'button_hover_border_color',
                            'heading'    => esc_html__('Button Hover Border Color', 'xtrail-core'),
                            'group'      => esc_html__('Button Style', 'xtrail-core')
                        ),
                        array(
                            'type'       => 'textfield',
                            'param_name' => 'additional_text',
                            'heading'    => esc_html__('Additional Text', 'xtrail-core'),
                        ),
                        array(
                            'type'       => 'textarea_html',
                            'param_name' => 'content',
                            'heading'    => esc_html__('Content', 'xtrail-core'),
                            'value'      => esc_html__('I am test text for Call to Action shortcode content', 'xtrail-core')
                        )
                    )
                )
            );
    ...
    public function render($atts, $content = null) {
        ...
        $html = xtrail_core_get_shortcode_module_template_part('templates/call-to-action', 'call-to-action', '', $params);
    ...
    private function getHolderClasses($params) {
        ...
        $holderClasses[] = $params['enable_box_holder'] === 'yes' ? 'qodef-call-to-action-boxed' : '';
    ...
    private function getButtonHolderStyles($params) {
        ...
        if (!empty($params['button_top_margin']) && $params['layout'] === 'simple') {
            $styles[] = 'margin-top: ' . xtrail_select_filter_px($params['button_top_margin']) . 'px';
        }
    ...
    private function getHolderStyles($params) {
        ...
        if (!empty($params['box_holder_shadow'])) {
            $styles[] = 'box-shadow: ' . $params['box_holder_shadow'];
        }

        if (!empty($params['box_holder_background'])) {
            $styles[] = 'background-color: ' . $params['box_holder_background'];
        }
