<?php
namespace XtrailCore\CPT\Shortcodes\Accordion;
...
class Accordion implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                    => esc_html__( 'Accordion', 'xtrail-core' ),
					'base'                    => $this->base,
					...
					'params'                  => array(
						...
						array(
							...
							'value'      => array(
								esc_html__( 'Accordion', 'xtrail-core' ) => 'accordion',
								esc_html__( 'Toggle', 'xtrail-core' )    => 'toggle'
							)
						),
						array(
							'type'       => 'dropdown',
						...
						array(
							...
							'heading'    => esc_html__( 'Background Skin', 'xtrail-core' ),
							'value'      => array(
								esc_html__( 'Default', 'xtrail-core' ) => '',
								esc_html__( 'White', 'xtrail-core' )   => 'white'
							),
	...
	public function render( $atts, $content = null ) {
		...
		$output = xtrail_core_get_shortcode_module_template_part( 'templates/accordion-holder-template', 'accordions', '', $params );
