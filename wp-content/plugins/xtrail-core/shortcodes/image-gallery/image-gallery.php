<?php
namespace XtrailCore\CPT\Shortcodes\ImageGallery;
...
class ImageGallery implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Image Gallery', 'xtrail-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							'type'        => 'dropdown',
							'param_name'  => 'type',
							'heading'     => esc_html__( 'Gallery Type', 'xtrail-core' ),
							'value'       => array(
								esc_html__( 'Image Grid', 'xtrail-core' ) => 'grid',
								esc_html__( 'Masonry', 'xtrail-core' )    => 'masonry',
								esc_html__( 'Slider', 'xtrail-core' )     => 'slider',
						...
						array(
							'type'        => 'attach_images',
							'param_name'  => 'images',
							'heading'     => esc_html__( 'Images', 'xtrail-core' ),
							'description' => esc_html__( 'Select images from media library', 'xtrail-core' )
						),
						array(
							'type'        => 'textfield',
						...
						array(
							...
							'heading'     => esc_html__( 'Custom Links', 'xtrail-core' ),
							'description' => esc_html__( 'Delimit links by comma', 'xtrail-core' ),
						...
						array(
							...
							'heading'     => esc_html__( 'Enable Slider Padding', 'xtrail-core' ),
							'description' => esc_html__( 'Padding left and right on stage (can see neighbours).', 'xtrail-core' ),
							'value'       => array_flip( xtrail_select_get_yes_no_select_array( false ) ),
							'save_always' => true,
							'dependency'  => array( 'element' => 'type', 'value' => array( 'slider' ) ),
							'group'       => esc_html__( 'Slider Settings', 'xtrail-core' )
	...
	public function render( $atts, $content = null ) {
		...
		$html = xtrail_core_get_shortcode_module_template_part( 'templates/' . $params['type'], 'image-gallery', '', $params );
	...
	private function getHolderClasses( $params, $args ) {
		...
		$holderClasses[] = $params['slider_navigation'] === 'yes' && $params['slider_pagination'] === 'yes' ? 'qodef-slider-has-both-nav' : '';
