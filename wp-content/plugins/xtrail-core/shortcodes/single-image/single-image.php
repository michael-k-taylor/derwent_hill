<?php
namespace XtrailCore\CPT\Shortcodes\SingleImage;
...
class SingleImage implements Lib\ShortcodeInterface {
	...
	public function vcMap() {
		if ( function_exists( 'vc_map' ) ) {
			vc_map(
				array(
					'name'                      => esc_html__( 'Single Image', 'xtrail-core' ),
					'base'                      => $this->getBase(),
					...
					'params'                    => array(
						...
						array(
							...
							'heading'    => esc_html__( 'Image Behavior', 'xtrail-core' ),
							'value'      => array(
								esc_html__( 'None', 'xtrail-core' )             => '',
								esc_html__( 'Open Lightbox', 'xtrail-core' )    => 'lightbox',
								esc_html__( 'Open Custom Link', 'xtrail-core' ) => 'custom-link',
								esc_html__( 'Zoom', 'xtrail-core' )             => 'zoom',
								esc_html__( 'Grayscale', 'xtrail-core' )        => 'grayscale',
								esc_html__( 'Moving on Hover', 'xtrail-core' )  => 'moving'
							)
						),
						array(
							'type'       => 'textfield',
	...
	public function render( $atts, $content = null ) {
		...
		$html = xtrail_core_get_shortcode_module_template_part( 'templates/single-image', 'single-image', '', $params );
