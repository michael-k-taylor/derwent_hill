<?php
if ( ! function_exists( 'xtrail_select_init_google_fonts_array' ) ) {
    function xtrail_select_init_google_fonts_array() {
...
';
        ...
        $xtrail_select_global_fonts_array = $google_fonts_decoded['items'];
    }
    add_action('after_setup_theme', 'xtrail_select_init_google_fonts_array');
}