...
include 'xtrail-instagram-helper.php';

/**
 * Class XtrailInstagramApi
 */
class XtrailInstagramApi {
	...
	const INSTAGRAM_CODE = 'xtrail_instagram_code';
	const INSTAGRAM_USER_ID = 'xtrail_instagram_user_id';
	const INSTAGRAM_TOKEN = 'xtrail_instagram_access_token';
	const INSTAGRAM_TOKEN_LONG_LIVED = 'xtrail_instagram_access_token_long_lived';
	const INSTAGRAM_TOKEN_LONG_LIVED_TIME = 'xtrail_instagram_access_token_long_lived_time';

	const FACEBOOK_CODE = 'xtrail_facebook_code';
	const FACEBOOK_TOKEN = 'xtrail_facebook_access_token';

	const CONNECTION_TYPE = 'xtrail_connection_type';
	...
	public function __construct() {
		...
		$this->helper = new XtrailInstagramHelper();
	}

	/**
	 * @return XtrailInstagramApi
	 */
	 ...
	 *
	 * @see XtrailInstagramApi::fetchData()
	 */
	 ...
	 * @return stdClass
	 *
	 * @see XtrailInstagramApi::instagramExchangeCodeForToken()
	 */
